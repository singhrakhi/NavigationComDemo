package com.test.navigationcomdemo
...
class SpecifyFragment : Fragment(),View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val message = "Sending message to $recipient"
        ...
        when(v!!.id){
            R.id.send_btn ->{
                ...
                if (!TextUtils.isEmpty(input_amount.text.toString())){
                    ...
                    "amount" to amount)
                    navController!!.navigate(R.id.action_specifyFragment_to_confirmationFragment,bundle )
                } else {
